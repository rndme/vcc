...
function VCC(def) {
  ...
  class vcc_proto extends HTMLElement {
	...
	attributeChangedCallback(e,old,v){	
	...
	detachedCallback(){
	  	if(typeof def.componentWillUnmount === "function") 	def.componentWillUnmount.call(this);
	  }//end detached
  
  }// end class vcc_proto
 
  return  customElements.define(tagName,   vcc_proto);
